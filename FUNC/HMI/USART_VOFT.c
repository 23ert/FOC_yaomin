...
{
    Uint16 Xbufsize = 0;
    FrameV.fdata[Xbufsize++] = MT_Sam.Udc;
	FrameV.fdata[Xbufsize++] = MT_Sam.Upot;
    FrameV.fdata[Xbufsize++] = MT_Sam.CurrU;
	FrameV.fdata[Xbufsize++] = MT_Sam.CurrV;
    FrameV.fdata[Xbufsize++] = MT_Sam.CurrW;

    //数据合并拷贝到数据buf
	memcpy(FrameV.data,(uint8_t*)&FrameV.fdata,sizeof(FrameV.fdata));
	
	//size_t a_len = CH_COUNT*4;
    size_t a_len = Xbufsize*4;
    size_t b_len = 4;
